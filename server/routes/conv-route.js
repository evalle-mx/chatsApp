...
convRoutes.route('/conversation')
    .get( function (req, res) {
        ...
        try{
            ...
            console.error(e);
            res.status(500).json({error:e.message, message:'Error on get' + 
            (e.message.includes('undefined')?' [Check Connectivity/collection object]':'')})
        }
    });
        ...
        .post( function (req, res) {
            ...
            */
            ...
            try {
                ...
                .insertOne(newChat, function(err, result){
                    if(err) {
                        ...
                        if (err.name === 'MongoServerError' && err.code === 11000) { 
                            ...
                            eMessage+='Already exists '+newChat.number;    //objChat._id
                        }
                ...
                console.error(e);
                res.status(500).json({error:e.message, message:'Error on get' + 
                (e.message.includes('undefined')?' [Check Connectivity]':'')})
            }
